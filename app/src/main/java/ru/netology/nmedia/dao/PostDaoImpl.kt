    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                likes = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_LIKES)).toString(),
                countLikes = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_COUNT_LIKES)),
                repost = getString(getColumnIndexOrThrow(PostColumns.COLUMN_REPOST)),
                countShare = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_COUNT_SHARE)),
                views = getString(getColumnIndexOrThrow(PostColumns.COLUMN_VIEWS)),
